...
# 直接添加路径
sys.path.insert(0, '/Users/kaiiangs/Desktop/another-me')

from ame.foundation.file.pipeline import DocumentParsePipeline, parse_document
from ame.foundation.file.base import SectionType
